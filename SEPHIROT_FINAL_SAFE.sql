-- ============================================================================
-- 🚀 SEPHIROT.XYZ - FINAL SAFE VERSION (DROP IF / CREATE IF)
-- ============================================================================
...
DROP INDEX IF EXISTS idx_api_requests_created_at CASCADE;
DROP INDEX IF EXISTS idx_api_requests_user_id CASCADE;
DROP INDEX IF EXISTS idx_rate_limits_ip CASCADE;
DROP INDEX IF EXISTS idx_database_health_created CASCADE;
DROP INDEX IF EXISTS idx_metrics_created CASCADE;
...
-- ============================================================================
-- Create indexes (safe - won't fail if exist)
-- ============================================================================
...
SELECT '✅ SEPHIROT PRODUCTION READY!' as status;
