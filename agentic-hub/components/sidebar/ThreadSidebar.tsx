...
export function ThreadSidebar({
  ...
  return (
    <div className="w-72 h-full bg-surface-1 border-r border-white/5 flex flex-col">
      {/* Header */}
      <div className="p-4">
        <button
          onClick={onNewThread}
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-brand-600 to-brand-500 text-white text-sm font-medium transition-all hover:shadow-lg hover:shadow-brand-500/20 active:scale-[0.98]"
        >
